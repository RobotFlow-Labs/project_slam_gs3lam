# TSUKUYOMI — Execution Ledger

Resume rule: Read this file COMPLETELY before writing any code.
This project covers exactly ONE paper: GS3LAM: Gaussian Semantic SLAM.

## 1. Working Rules
- Work only inside `project_tsukuyomi/`
- This wave has 17 parallel projects, 17 papers, 17 agents
- Prefix every commit with `[TSUKUYOMI]`
- Stage only `project_tsukuyomi/` files
