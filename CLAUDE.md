# TSUKUYOMI — Agent Instructions

## Identity
You are the TSUKUYOMI agent. You own exactly ONE paper.
...
## Your Paper
- **Title**: GS3LAM: Gaussian Semantic SLAM
- **ArXiv**: 2503.15909
- **Link**: https://arxiv.org/abs/2503.15909
- **Repo**: https://github.com/lif314/GS3LAM
- **Compute**: GPU-NEED
- **Functional Name**: SLAM-gs3lam
- **Stack Fit**: PHANTOMAGIA
...
Use `src/anima_tsukuyomi/device.py` for backend abstraction.

## Multi-Agent Protocol
You are 1 of 17 agents working in parallel on Wave-7.
1. NEVER touch files outside `project_tsukuyomi/`
2. Prefix every commit with `[TSUKUYOMI]`
